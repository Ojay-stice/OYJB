  ...
  const jobs = [
    {
      ...
      remote: true,
      postedAt: "2025-01-05",
       description:" Lorem ipsum dolor sit amet, consectetur adipisicing elit. Reiciendis nihil aperiam eius delectus ratione exercitationem veniam quam eveniet rem a eum id, quod atque facilis cumque, libero minima distinctio ex? Beatae corrupti nam quaerat alias eius quisquam minima nihil error, cupiditate dolor atque pariatur odio debitis itaque, ipsa eum aut, voluptate quos ea voluptates reprehenderit. Vitae perferendis illum nobis officia!",
    },
    {
      id: 2,
  ...
  return (
    <div>
      <button
        ...
        className={`${
          toggleJobs == index
            ? "bg-[#0088FF] transition-all duration-700 ease-in-out"
            : ""
        }  ${className}`}
      >
        {icon}
